...
//                            $table.find('tr:first').append('<th class="tabledit-toolbar-column">Action</th>');
//                        }
//
//                        // Create edit button.
//                        if (settings.editButton) {
    ...
    $.Tabledit = function(element, options) {
        ...
        var defaults = {
            ...
            buttons: {
                edit: {
                    class: 'btn btn-sm btn-default',
                    html: '<span class="fa fa-pencil-alt text-info"></span>',
                    action: 'edit'
                },
                delete: {
                    class: 'btn btn-sm btn-default',
                    html: '<span class="fa fa-trash text-danger"></span>',
                    action: 'delete'
                },
                save: {
                    class: 'btn btn-sm btn-danger',
                    html: '<span class="fa fa-check-double">Valider</span>'
                },
                restore: {
                    class: 'btn btn-sm btn-warning',
                    html: 'Restore',
            ...
            columns: {
                ...
                toolbar: function() {
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        // Add toolbar column header if not exists.
                        if ($table.find('th.tabledit-toolbar-column').length === 0) {
                            $table.find('tr:first').append('<th class="tabledit-toolbar-column">Option</th>');
                        }
                        ...
                        // Add toolbar column cells.
                        $table.find('tr:gt(0):not([data-tabledit-done])').append('<td class="text-center" style="white-space: nowrap; width: 1%;">' + toolbar + '</td>').attr('data-tabledit-done', 1);
                    }
                }
            }
        };
